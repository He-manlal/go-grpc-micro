...
import (
	...
	pb "github.com/He-manlal/go-grpc-microservice/account/pb/go-grpc-micro/account"
)
...
func (c *Client) GetAccounts(ctx context.Context, name string, skip uint64, take uint64) ([]Account, error) {
