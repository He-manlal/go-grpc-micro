...
type AccountServiceClient interface {
	...
	GetAccount(ctx context.Context, in *GetAccountRequest, opts ...grpc.CallOption) (*PostAccountResponse, error)
	GetAccounts(ctx context.Context, in *GetAccountsRequest, opts ...grpc.CallOption) (*GetAccountResponse, error)
}
...
func (c *accountServiceClient) GetAccount(ctx context.Context, in *GetAccountRequest, opts ...grpc.CallOption) (*PostAccountResponse, error) {
	out := new(PostAccountResponse)
...
func (c *accountServiceClient) GetAccounts(ctx context.Context, in *GetAccountsRequest, opts ...grpc.CallOption) (*GetAccountResponse, error) {
...
type AccountServiceServer interface {
	...
	GetAccount(context.Context, *GetAccountRequest) (*PostAccountResponse, error)
	GetAccounts(context.Context, *GetAccountsRequest) (*GetAccountResponse, error)
...
func (UnimplementedAccountServiceServer) GetAccount(context.Context, *GetAccountRequest) (*PostAccountResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAccount not implemented")
}
func (UnimplementedAccountServiceServer) GetAccounts(context.Context, *GetAccountsRequest) (*GetAccountResponse, error) {
